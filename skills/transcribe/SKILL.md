...
export TRANSCRIBE_CLI="$AGENTS_HOME/skills/transcribe/scripts/transcribe_diarize.py"
```

User-scoped skills install under `$AGENTS_HOME/skills` (default: `~/.agents/skills`).
